...
DOMINO_PIPELINES: list[DominoPipeline] = [
 ...
 steps=[
 DominoStep("check_gpu", "bash:nvidia-smi --query-gpu=temperature.gpu,memory.used --format=csv,noheader", "bash"),
 ...
 DominoStep("agenda_resume", "bash:date +'%A %d %B %Y %H:%M'", "bash"),
 ...
 DominoStep("git_status", "bash:git -C '/home/turbo/jarvis-m1-ops' status --short", "bash"),
 ...
 steps=[
 DominoStep("gpu_temp", "bash:nvidia-smi --query-gpu=temperature.gpu --format=csv,noheader", "bash"),
 DominoStep("date_heure", "bash:date +'%H:%M %A'", "bash"),
 ...
 steps=[
 DominoStep("gpu_light", "bash:nvidia-smi --query-gpu=temperature.gpu --format=csv,noheader", "bash"),
 ...
 steps=[
 DominoStep("read_temps", "bash:nvidia-smi --query-gpu=name,temperature.gpu,power.draw --format=csv,noheader", "bash"),
 DominoStep("check_fans", "bash:nvidia-smi --query-gpu=fan.speed --format=csv,noheader", "bash"),
 ...
 steps=[
 DominoStep("ping_gateway", "bash:ping -c 2 -W 3 192.168.1.1", "bash"),
 DominoStep("ping_internet", "bash:ping -c 2 -W 3 8.8.8.8", "bash"),
 DominoStep("dns_check", "bash:dig +short google.com 2>/dev/null", "bash"),
 DominoStep("cluster_lan", "bash:ping -c 1 -W 3 127.0.0.1", "bash", on_fail="skip"),
 ...
 DominoStep("size_check", "bash:stat '/home/turbo/jarvis-m1-ops/data/etoile.db'", "bash"),
 ...
 steps=[
 DominoStep("git_status", "bash:git -C '/home/turbo/jarvis-m1-ops' status --short", "bash"),
 DominoStep("run_tests", "bash:cd /home/turbo/jarvis-m1-ops && uv run python -m pytest tests/ -q 2>&1", "bash", on_fail="stop"),
 DominoStep("git_add_commit", "bash:git -C '/home/turbo/jarvis-m1-ops' add -A && git -C '/home/turbo/jarvis-m1-ops' commit -m 'auto-deploy'", "bash"),
 DominoStep("git_push", "bash:git -C '/home/turbo/jarvis-m1-ops' push", "bash"),
 ...
 steps=[
 DominoStep("git_stash", "bash:git -C '/home/turbo/jarvis-m1-ops' stash", "bash"),
 DominoStep("apply_fix", "bash:git -C '/home/turbo/jarvis-m1-ops' add -A", "bash"),
 DominoStep("commit_hotfix", "bash:git -C '/home/turbo/jarvis-m1-ops' commit -m 'hotfix: correction urgente'", "bash"),
 DominoStep("push_hotfix", "bash:git -C '/home/turbo/jarvis-m1-ops' push", "bash"),
 ...
 steps=[
 DominoStep("get_last_commit", "bash:git -C '/home/turbo/jarvis-m1-ops' log -1 --oneline", "bash"),
 DominoStep("revert_commit", "bash:git -C '/home/turbo/jarvis-m1-ops' revert HEAD --no-edit", "bash"),
 DominoStep("push_revert", "bash:git -C '/home/turbo/jarvis-m1-ops' push", "bash"),
 ...
 DominoStep("backup_config", "bash:cp '/home/turbo/jarvis-m1-ops/.env' '/home/turbo/jarvis-m1-ops/.env.bak'", "bash"),
 DominoStep("run_tests", "bash:cd /home/turbo/jarvis-m1-ops && uv run python -m pytest tests/ -q 2>&1", "bash", on_fail="stop"),
 DominoStep("git_commit_push", "bash:git -C '/home/turbo/jarvis-m1-ops' add -A && git -C '/home/turbo/jarvis-m1-ops' commit -m 'safe-deploy' && git -C '/home/turbo/jarvis-m1-ops' push", "bash"),
 ...
 steps=[
 DominoStep("check_ports", "bash:ss -tuln | sort", "bash"),
 DominoStep("check_firewall", "bash:sudo ufw status", "bash"),
 DominoStep("check_env_files", "bash:ls -R '/home/turbo/jarvis-m1-ops' -r -name '.env*'", "bash"),
 DominoStep("check_processes", "bash:ps aux", "bash"),
 ...
 steps=[
 DominoStep("list_env", f"bash:cat '{_TURBO_DIR}/.env' | grep 'KEY|TOKEN|SECRET' | wc", "bash"),
 DominoStep("check_git_history", f"bash:git -C '{_TURBO_DIR}' log --oneline -5 -- '*.env*'", "bash"),
 ...
 steps=[
 DominoStep("active_connections", "bash:ss -tuln | sort | uniq -c| sort", "bash"),
 DominoStep("unknown_ips", "bash:ss -tuln", "bash"),
 ...
 steps=[
 DominoStep("check_acl", "bash:(Get-Acl '/home/turbo/jarvis-m1-ops').Access", "bash"),
 DominoStep("check_sensitive", "bash:ls '/home/turbo/jarvis-m1-ops/data' -name '*.db'", "bash"),
 ...
 steps=[
 DominoStep("gpu_all_metrics", "bash:nvidia-smi --query-gpu=name,temperature.gpu,utilization.gpu,memory.used,memory.total,power.draw --format=csv,noheader", "bash"),
 DominoStep("gpu_processes", "bash:nvidia-smi --query-compute-apps=pid,name,used_memory --format=csv,noheader", "bash"),
 ...
 steps=[
 DominoStep("check_vram", "bash:nvidia-smi --query-gpu=memory.used,memory.total --format=csv,noheader", "bash"),
 DominoStep("kill_idle", "python:kill_idle_gpu_processes()", "python"),
 DominoStep("verify_free", "bash:nvidia-smi --query-gpu=memory.free --format=csv,noheader", "bash"),
 ...
 steps=[
 DominoStep("read_temps", "bash:nvidia-smi --query-gpu=temperature.gpu --format=csv,noheader", "bash"),
 DominoStep("kill_heavy", "python:kill_heaviest_gpu_process()", "python", condition="any_gpu > 85"),
 DominoStep("reduce_power", "bash:nvidia-smi -pl 150", "bash"),
 ...
 DominoStep("backup_config", "bash:cp '/home/turbo/jarvis-m1-ops/.env','/home/turbo/jarvis-m1-ops/pyproject.toml' '/home/turbo/jarvis-m1-ops/backups/' ", "bash"),
 DominoStep("backup_git", "bash:git -C '/home/turbo/jarvis-m1-ops' bundle create '/home/turbo/jarvis-m1-ops/backups/turbo.bundle' --all", "bash"),
 DominoStep("verify_backup", "bash:ls '/home/turbo/jarvis-m1-ops/backups/' -File | sort", "bash"),
 ...
 steps=[
 DominoStep("list_backups", "bash:ls '/home/turbo/jarvis-m1-ops/backups/' -name '*.db*' | sort", "bash"),
 ...
 steps=[
 DominoStep("cpu_ram", "bash:free -m", "bash"),
 DominoStep("disk_space", "bash:df -h", "bash"),
 DominoStep("gpu_status", "bash:nvidia-smi --query-gpu=temperature.gpu,memory.used --format=csv,noheader", "bash"),
 ...
 DominoStep("check_gpu_temp", "bash:nvidia-smi --query-gpu=temperature.gpu --format=csv,noheader", "bash"),
 DominoStep("check_disk", "bash:df -h", "bash"),
 ...
 steps=[
 DominoStep("cpu_bench", "bash:(top -bn1).LoadPercentage", "bash"),
 DominoStep("mem_bench", "bash:[math]::Round((free -m).FreePhysicalMemory/1MB,1)", "bash"),
 DominoStep("gpu_bench", "bash:nvidia-smi --query-gpu=utilization.gpu --format=csv,noheader", "bash"),
 DominoStep("io_bench", "bash:(Get-Counter '/PhysicalDisk(_Total)/Disk Bytes/sec' 2>/dev/null).CounterSamples.CookedValue", "bash"),
 ...
 DominoStep("reduce_gpu", "bash:nvidia-smi -pl 100", "bash"),
 ...
 DominoStep("reduce_all_gpu", "bash:nvidia-smi -pl 80", "bash"),
 ...
 steps=[
 DominoStep("check_network", "bash:ping -c 1 -W 3 8.8.8.8", "bash"),
 ...
 steps=[
 DominoStep("stop_obs", "bash:pkill -f obs64,obs32 2>/dev/null", "bash"),
 ...
 steps=[
 DominoStep("smart_status", "bash:lsblk", "bash", timeout_s=15),
 DominoStep("disk_space", "bash:df -h", "bash", timeout_s=10),
 DominoStep("io_latency", "bash:Get-Counter '/PhysicalDisk(*)/Avg. Disk sec/Read' -SampleInterval 1 -MaxSamples 1", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("gpu_wear", "bash:nvidia-smi --query-gpu=name,temperature.gpu,power.draw,memory.used --format=csv,noheader,nounits", "bash", timeout_s=10),
 DominoStep("uptime_check", "bash:(free -m).LastBootUpTime", "bash", timeout_s=10),
 DominoStep("event_errors", "bash:Get-EventLog -LogName System -EntryType Error -Newest 10", "bash", on_fail="skip", timeout_s=15),
 ...
 steps=[
 DominoStep("collect_logs", "bash:ls /home/turbo/jarvis-m1-ops/logs -name *.log | wc -Property Length -Sum", "bash", timeout_s=10),
 DominoStep("archive_old", "bash:ls /home/turbo/jarvis-m1-ops/logs -name *.log | Compress-Archive Path /home/turbo/jarvis-m1-ops/logs/archive_$$(date +%Y%m%d).zip ", "bash", timeout_s=20, on_fail="skip"),
 DominoStep("purge_archived", "bash:ls /home/turbo/jarvis-m1-ops/logs -name *.log | rm -f ", "bash", timeout_s=10, on_fail="skip"),
 ...
 DominoStep("disable_notifs", "bash:echo -Path '/tmp//Software/Microsoft/Windows/CurrentVersion/PushNotifications' -Name 'ToastEnabled' -Value 0 2>/dev/null", "bash", on_fail="skip", timeout_s=10),
 ...
 steps=[
 DominoStep("close_distractions", "bash:pkill -f discord,slack,telegram 2>/dev/null", "bash", on_fail="skip", timeout_s=10),
 DominoStep("disable_notifs", "bash:echo -Path '/tmp//Software/Microsoft/Windows/CurrentVersion/PushNotifications' -Name 'ToastEnabled' -Value 0 2>/dev/null", "bash", on_fail="skip", timeout_s=10),
 DominoStep("gpu_optimize", "bash:nvidia-smi --query-gpu=utilization.gpu --format=csv,noheader,nounits", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("git_summary", "bash:git -C /home/turbo/jarvis-m1-ops log --oneline --since='8 hours ago' | wc -l", "bash", timeout_s=10),
 DominoStep("gpu_usage", "bash:nvidia-smi --query-gpu=name,utilization.gpu --format=csv,noheader", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("collect_status", "bash:nvidia-smi --query-gpu=temperature.gpu --format=csv,noheader,nounits", "bash", timeout_s=10),
 ...
 DominoStep("check_gpu", "bash:nvidia-smi --query-gpu=temperature.gpu --format=csv,noheader,nounits", "bash", timeout_s=10),
 ...
 DominoStep("show_toast", "bash:[Windows.UI.Notifications.ToastNotificationManager, Windows.UI.Notifications, ContentType = WindowsRuntime] > $null; $template = [Windows.UI.Notifications.ToastNotificationManager]::GetTemplateContent([Windows.UI.Notifications.ToastTemplateType]::ToastText01); $template.GetElementsByTagName('text')[0].AppendChild($template.CreateTextNode('JARVIS: Systeme OK')) > $null; [Windows.UI.Notifications.ToastNotificationManager]::CreateToastNotifier('JARVIS').Show([Windows.UI.Notifications.ToastNotification]::new($template))", "bash", on_fail="skip", timeout_s=15),
 ...
 steps=[
 DominoStep("arp_scan", "bash:arp -a | grep 'dynamic'", "bash", timeout_s=10),
 DominoStep("ip_config", "bash:ip -4 addr", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("dns_resolve", "bash:dig +short google.com", "bash", timeout_s=10),
 DominoStep("dns_servers", "bash:cat /etc/resolv.conf -AddressFamily IPv4", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("gpu_check", "bash:nvidia-smi --query-gpu=power.draw,power.limit --format=csv,noheader", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("gpu_status", "bash:nvidia-smi --query-gpu=name,power.draw,utilization.gpu --format=csv,noheader", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("check_temps", "bash:nvidia-smi --query-gpu=temperature.gpu,power.draw --format=csv,noheader", "bash", timeout_s=5),
 DominoStep("list_cuda", "bash:ps aux", "bash", on_fail="skip", timeout_s=10),
 ...
 steps=[
 DominoStep("quick_git", "bash:cd /home/turbo/jarvis-m1-ops && git status --short | head -10", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("list_heavy", "bash:ps aux | sort", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("check_date", "bash:date +'%A %d %B %Y %H:%M'", "bash", timeout_s=5),
 DominoStep("git_pending", "bash:cd /home/turbo/jarvis-m1-ops && git status --short | wc -l", "bash", timeout_s=10),
 ...
 DominoStep("focus_log", "bash:echo \"$(date '+%Y-%m-%d %H:%M') POMODORO START\" >> /home/turbo/jarvis-m1-ops/data/pomodoro_log.txt", "bash", timeout_s=5),
 ],
 category="task_scheduling",
 ...
 steps=[
 DominoStep("dataset_count", "bash:wc -l /home/turbo/jarvis-m1-ops/data/domino_learning_dataset.jsonl", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("dataset_stats", "bash:wc -l /home/turbo/jarvis-m1-ops/data/domino_learning_dataset.jsonl", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("net_check", "bash:nc -zv 8.8.8.8 443 -InformationLevel Quiet", "bash", timeout_s=10),
 DominoStep("audio_check", "bash:Get-PnpDevice -Class AudioEndpoint -Status OK", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("create_note", "bash:echo \"# Notes - $(date '+%Y-%m-%d %H:%M')\" > /home/turbo/jarvis-m1-ops/data/meeting_notes_$(date '+%Y%m%d').md", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("gpu_status", "bash:nvidia-smi --query-gpu=name,utilization.gpu --format=csv,noheader", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("gpu_status", "bash:nvidia-smi --query-gpu=temperature.gpu --format=csv,noheader,nounits", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("recent_changes", "bash:cd /home/turbo/jarvis-m1-ops && git diff --stat HEAD~3 2>/dev/null || echo 'No recent changes'", "bash", timeout_s=10),
 DominoStep("todo_check", "bash:cd /home/turbo/jarvis-m1-ops && grep -r 'TODO/|FIXME' src/ --include='*.py' -c 2>/dev/null || echo '0'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("count_temp", "bash:ls -R $TEMP -r 2>/dev/null | wc -Property Length -Sum", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("find_orphans", "bash:ps aux", "bash", timeout_s=10, on_fail="skip"),
 DominoStep("high_cpu", "bash:ps aux | sort", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("git_gc", "bash:cd /home/turbo/jarvis-m1-ops && git gc --auto 2>&1 | tail -3", "bash", timeout_s=30, on_fail="skip"),
 DominoStep("git_prune", "bash:cd /home/turbo/jarvis-m1-ops && git remote prune origin 2>&1 | head -5", "bash", timeout_s=15, on_fail="skip"),
 DominoStep("git_size", "bash:cd /home/turbo/jarvis-m1-ops && du -sh .git 2>/dev/null || echo '.git size N/A'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("gpu_clocks", "bash:nvidia-smi --query-gpu=name,clocks.current.graphics,clocks.current.memory,power.draw --format=csv,noheader", "bash", timeout_s=10),
 DominoStep("gpu_procs", "bash:nvidia-smi --query-compute-apps=pid,name,used_memory --format=csv,noheader 2>/dev/null || echo 'No GPU processes'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("ram_status", "bash:$os=free -m; [math]::Round(($os.TotalVisibleMemorySize-$os.FreePhysicalMemory)/1MB,1).ToString()+'GB / '+[math]::Round($os.TotalVisibleMemorySize/1MB,1).ToString()+'GB'", "bash", timeout_s=10),
 DominoStep("top_ram", "bash:ps aux | sort", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("count_dominos", "bash:cd /home/turbo/jarvis-m1-ops && python3 -c \"from src.domino_pipelines import DOMINO_PIPELINES; print(f'{len(DOMINO_PIPELINES)} cascades')\"", "bash", timeout_s=10),
 DominoStep("count_dataset", "bash:wc -l /home/turbo/jarvis-m1-ops/data/domino_learning_dataset.jsonl", "bash", timeout_s=5),
 ...
 DominoStep("gpu_temps", "bash:nvidia-smi --query-gpu=name,temperature.gpu --format=csv,noheader", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("count_files", "bash:cd /home/turbo/jarvis-m1-ops && find src/ -name '*.py' | wc -l", "bash", timeout_s=10),
 DominoStep("count_lines", "bash:cd /home/turbo/jarvis-m1-ops && wc -l src/*.py src/**/*.py 2>/dev/null | tail -1 || echo 'N/A'", "bash", timeout_s=10, on_fail="skip"),
 DominoStep("git_commits", "bash:cd /home/turbo/jarvis-m1-ops && git rev-list --count HEAD", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("recent_commits", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --since='7 days ago' | head -20", "bash", timeout_s=10),
 DominoStep("files_changed", "bash:cd /home/turbo/jarvis-m1-ops && git diff --stat HEAD~10 2>/dev/null | tail -3", "bash", timeout_s=10),
 ...
 DominoStep("log_meeting", "bash:echo \"$(date '+%Y-%m-%d %H:%M') MEETING START\" >> /home/turbo/jarvis-m1-ops/data/meeting_log.txt", "bash", timeout_s=5),
 ],
 category="meeting_assistant",
 ...
 steps=[
 DominoStep("python_syntax", "bash:cd /home/turbo/jarvis-m1-ops && python3 -m py_compile src/domino_pipelines.py 2>&1 && echo 'SYNTAX OK' || echo 'SYNTAX ERROR'", "bash", timeout_s=10),
 DominoStep("import_check", "bash:cd /home/turbo/jarvis-m1-ops && python3 -c 'from src.domino_pipelines import DOMINO_PIPELINES; print(f\"{len(DOMINO_PIPELINES)} cascades OK\")' 2>&1", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("random_domino", "bash:cd /home/turbo/jarvis-m1-ops && python3 -c \"import random; from src.domino_pipelines import DOMINO_PIPELINES; dp=random.choice(DOMINO_PIPELINES); print(f'Quiz: {dp.description}')\"", "bash", timeout_s=10),
 ...
 DominoStep("gpu_all", "bash:nvidia-smi --query-gpu=name,temperature.gpu,memory.used,memory.total,utilization.gpu --format=csv,noheader", "bash", timeout_s=10),
 DominoStep("vram_summary", "bash:nvidia-smi --query-gpu=memory.used,memory.total --format=csv,noheader", "bash"),
 ...
 DominoStep("disable_notifs", "bash:echo -Path '/tmp//Software/Microsoft/Windows/CurrentVersion/Notifications/Settings' -Name 'NOC_GLOBAL_SETTING_TOASTS_ENABLED' -Value 0 -PropertyType DWORD 2>/dev/null", "bash", on_fail="skip"),
 ...
 steps=[
 DominoStep("git_today", "bash:git -C '/home/turbo/jarvis-m1-ops' log --oneline --since='midnight' --format='%h %s'", "bash"),
 ...
 DominoStep("git_prune", "bash:git -C '/home/turbo/jarvis-m1-ops' gc --prune=now", "bash", timeout_s=60),
 DominoStep("clean_temp", "bash:rm -f -Path $TEMP/* -r 2>/dev/null; Write-Output 'Temp nettoye'", "bash", on_fail="skip", timeout_s=30),
 DominoStep("clean_logs", "bash:ls '/home/turbo/jarvis-m1-ops/data/*.log' 2>/dev/null | rm -f 2>/dev/null", "bash", on_fail="skip"),
 ...
 steps=[
 DominoStep("git_diff", "bash:git -C '/home/turbo/jarvis-m1-ops' diff --stat HEAD~3", "bash"),
 DominoStep("lint_check", "bash:cd /home/turbo/jarvis-m1-ops && uv run python -m ruff check src/ --statistics 2>&1", "bash", on_fail="skip", timeout_s=30),
 DominoStep("type_check", "bash:cd /home/turbo/jarvis-m1-ops && npx tsc --noEmit 2>&1", "bash", on_fail="skip", timeout_s=30),
 DominoStep("test_quick", "bash:cd /home/turbo/jarvis-m1-ops && uv run python -m pytest tests/ -q --tb=no 2>&1", "bash", on_fail="skip", timeout_s=60),
 ...
 DominoStep("check_gpu", "bash:nvidia-smi --query-gpu=temperature.gpu,utilization.gpu,memory.used --format=csv,noheader", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("git_status", "bash:cd /home/turbo/jarvis-m1-ops && git status --short", "bash", timeout_s=10),
 DominoStep("git_log", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline -10", "bash", timeout_s=10),
 DominoStep("git_branch", "bash:cd /home/turbo/jarvis-m1-ops && git branch -vv", "bash", timeout_s=5),
 ...
 DominoStep("check_vram", "bash:nvidia-smi --query-gpu=memory.used,memory.total --format=csv,noheader", "bash"),
 DominoStep("kill_idle", "python:kill_idle_gpu_processes()", "python"),
 DominoStep("check_after", "bash:nvidia-smi --query-gpu=memory.used,memory.total --format=csv,noheader", "bash"),
 ...
 steps=[
 DominoStep("git_yesterday", "bash:cd /home/turbo/jarvis-m1-ops && git log --since='yesterday' --oneline", "bash", timeout_s=10),
 ...
 DominoStep("clean_pycache", "bash:find /home/turbo/jarvis-m1-ops -type d -name __pycache__ -exec rm -rf {} + 2>/dev/null; echo OK", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("check_c", "bash:df -h", "bash"),
 DominoStep("check_f", "bash:df -h", "bash", on_fail="skip"),
 ...
 steps=[
 DominoStep("git_status", "bash:cd /home/turbo/jarvis-m1-ops && git status --short | head -20", "bash", timeout_s=10),
 DominoStep("git_add", "bash:cd /home/turbo/jarvis-m1-ops && git add -A", "bash", timeout_s=10),
 DominoStep("git_commit", "bash:cd /home/turbo/jarvis-m1-ops && git commit -m 'auto: sauvegarde vocale $(date +%Y%m%d_%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("git_status", "bash:cd /home/turbo/jarvis-m1-ops && git status --short", "bash", timeout_s=10),
 DominoStep("git_push", "bash:cd /home/turbo/jarvis-m1-ops && git push 2>&1 | tail -3", "bash", timeout_s=30),
 ...
 DominoStep("env_file", f"bash:test -f /home/turbo/jarvis-m1-ops/.env && echo '.env exists' || echo '.env MISSING'", "bash", timeout_s=5),
 ...
 DominoStep("log_size", "bash:ls -lh /home/turbo/jarvis-m1-ops/data/*.log 2>/dev/null || echo 'No logs'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("save_state", "python:save_session_state()", "python"),
 DominoStep("git_snapshot", "bash:cd /home/turbo/jarvis-m1-ops && git stash push -m 'session-snapshot-$(date +%Y%m%d_%H%M)' 2>&1 && git stash pop 2>&1 || echo 'Nothing to stash'", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("read_temps", "bash:nvidia-smi --query-gpu=name,temperature.gpu --format=csv,noheader", "bash"),
 ...
 steps=[
 DominoStep("syntax_check", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && echo 'ALL SYNTAX OK'", "bash", timeout_s=15),
 DominoStep("import_check", "bash:cd /home/turbo/jarvis-m1-ops && python -c 'from src.commands import COMMANDS; from src.voice_correction import process_voice_command; from src.domino_pipelines import DOMINO_PIPELINES; print(f\"OK: {len(COMMANDS)} cmds, {len(DOMINO_PIPELINES)} dominos\")'", "bash", timeout_s=15),
 ...
 DominoStep("check_gpu_usage", "bash:nvidia-smi --query-gpu=name,utilization.gpu,memory.used --format=csv,noheader", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("cpu_ram", "bash:$os=free -m; $cpu=(top -bn1).LoadPercentage; $ram=[math]::Round(($os.TotalVisibleMemorySize-$os.FreePhysicalMemory)/1MB,1); Write-Output \"CPU: ${cpu}% | RAM: ${ram}GB\"", "bash", timeout_s=10),
 DominoStep("gpu_all", "bash:nvidia-smi --query-gpu=name,temperature.gpu,memory.used,memory.total,utilization.gpu --format=csv,noheader", "bash", timeout_s=10),
 DominoStep("disk_all", "bash:df -h", "bash", timeout_s=10),
 DominoStep("cluster_health", "curl:http://127.0.0.1:1234/api/v1/models", "curl", timeout_s=5, on_fail="skip"),
 DominoStep("ollama_status", "curl:http://127.0.0.1:11434/api/tags", "curl", timeout_s=5, on_fail="skip"),
 DominoStep("git_status", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline -3", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("date_heure", "bash:date +'%A %d %B %Y %H:%M'", "bash", timeout_s=5),
 DominoStep("gpu_status", "bash:nvidia-smi --query-gpu=name,temperature.gpu,memory.used,memory.total --format=csv,noheader", "bash", timeout_s=10),
 ...
 DominoStep("disk_space", "bash:df -h 2>/dev/null", "bash", timeout_s=10),
 DominoStep("git_pending", "bash:cd /home/turbo/jarvis-m1-ops && git status --short | wc -l", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("git_commit", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git commit -m 'auto: fin de journee $(date +%Y%m%d)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15),
 DominoStep("git_push", "bash:cd /home/turbo/jarvis-m1-ops && git push 2>&1 || echo 'Push failed or nothing to push'", "bash", timeout_s=30, on_fail="skip"),
 ...
 steps=[
 DominoStep("git_week", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --since='7 days ago' | wc -l", "bash", timeout_s=10),
 DominoStep("git_stats", "bash:cd /home/turbo/jarvis-m1-ops && git diff --stat HEAD~20 2>/dev/null | tail -3", "bash", timeout_s=10),
 DominoStep("db_stats", "python:sqlite3_table_counts('etoile.db')", "python", on_fail="skip"),
 ...
 steps=[
 DominoStep("count_cmds", "bash:cd /home/turbo/jarvis-m1-ops && python -c 'from src.commands import COMMANDS, VOICE_CORRECTIONS; print(f\"{len(COMMANDS)} cmds, {len(VOICE_CORRECTIONS)} corrections\")'", "bash", timeout_s=10),
 DominoStep("count_implicits", "bash:cd /home/turbo/jarvis-m1-ops && python -c 'from src.voice_correction import IMPLICIT_COMMANDS; print(f\"{len(IMPLICIT_COMMANDS)} implicits\")'", "bash", timeout_s=10),
 DominoStep("count_dominos", "bash:cd /home/turbo/jarvis-m1-ops && python -c 'from src.domino_pipelines import DOMINO_PIPELINES; print(f\"{len(DOMINO_PIPELINES)} dominos\")'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("git_graph", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --graph -15", "bash", timeout_s=10),
 DominoStep("git_authors", "bash:cd /home/turbo/jarvis-m1-ops && git shortlog -sn --since='30 days ago' | head -5", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("count_logs", "bash:ls -la /home/turbo/jarvis-m1-ops/data/*.log 2>/dev/null | wc -l", "bash", timeout_s=5),
 DominoStep("archive_old", "bash:ls '/home/turbo/jarvis-m1-ops/data/*.log' | ForEach-Object { mv $_.FullName ($_.FullName + '.archived') }; 'Logs archives'", "bash", on_fail="skip", timeout_s=15),
 ...
 steps=[
 DominoStep("open_ports", "bash:ss -tuln| wc", "bash", timeout_s=10),
 DominoStep("firewall", "bash:sudo ufw status", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("git_status", "bash:cd /home/turbo/jarvis-m1-ops && git status --short", "bash", timeout_s=5),
 DominoStep("git_diff_stats", "bash:cd /home/turbo/jarvis-m1-ops && git diff --stat HEAD~1", "bash", timeout_s=10),
 DominoStep("py_lint", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'ALL SYNTAX OK'", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("syntax_check", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK'", "bash", timeout_s=10),
 DominoStep("git_add", "bash:cd /home/turbo/jarvis-m1-ops && git add -A", "bash", timeout_s=5),
 DominoStep("git_commit", "bash:cd /home/turbo/jarvis-m1-ops && git commit -m 'deploy: staging $(date +%Y%m%d-%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=10),
 DominoStep("git_push", "bash:cd /home/turbo/jarvis-m1-ops && git push 2>&1 || echo 'Push failed'", "bash", timeout_s=30, on_fail="skip"),
 ...
 steps=[
 DominoStep("prune_remote", "bash:cd /home/turbo/jarvis-m1-ops && git remote prune origin 2>&1", "bash", timeout_s=15, on_fail="skip"),
 DominoStep("list_merged", "bash:cd /home/turbo/jarvis-m1-ops && git branch --merged main 2>/dev/null | grep -v main | head -10 || echo 'No merged branches'", "bash", timeout_s=10),
 DominoStep("gc", "bash:cd /home/turbo/jarvis-m1-ops && git gc --auto 2>&1", "bash", timeout_s=30, on_fail="skip"),
 ...
 steps=[
 DominoStep("count_errors", "bash:grep -ci 'error/|exception/|fail' /home/turbo/jarvis-m1-ops/data/*.log 2>/dev/null || echo '0 errors'", "bash", timeout_s=10),
 DominoStep("recent_errors", "bash:grep -i 'error/|exception' /home/turbo/jarvis-m1-ops/data/*.log 2>/dev/null | tail -5 || echo 'No recent errors'", "bash", timeout_s=10, on_fail="skip"),
 ...
 DominoStep("uv_sync", "bash:cd /home/turbo/jarvis-m1-ops && uv sync 2>&1 | tail -3", "bash", timeout_s=30, on_fail="skip"),
 ...
 DominoStep("git_commit", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git commit -m 'backup: full system $(date +%Y%m%d)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15, on_fail="skip"),
 ...
 steps=[
 DominoStep("cpu", "bash:top -bn1", "bash", timeout_s=10),
 DominoStep("ram", "bash:[math]::Round((free -m).FreePhysicalMemory/1MB,1)", "bash", timeout_s=10),
 DominoStep("gpu", "bash:nvidia-smi --query-gpu=utilization.gpu,temperature.gpu,memory.used --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10, on_fail="skip"),
 DominoStep("disk", "bash:df -h 2>/dev/null", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("git_save", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git commit -m 'auto: pause midi $(date +%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15, on_fail="skip"),
 DominoStep("lock_screen", "bash:rundll32.exe user32.dll,LockWorkStation", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("save_state", "bash:cd /home/turbo/jarvis-m1-ops && git stash 2>&1 || echo 'Nothing to stash'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("disable_notif", "bash:echo -Path '/tmp//SOFTWARE/Microsoft/Windows/CurrentVersion/PushNotifications' -Name 'ToastEnabled' -Value 0 2>/dev/null; 'Notifications disabled'", "bash", timeout_s=5, on_fail="skip"),
 ...
 steps=[
 DominoStep("disk_space", "bash:df -h", "bash", timeout_s=10),
 DominoStep("smart", "bash:lsblk", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("clear_standby", "bash:[System.GC]::Collect(); 'GC collected'", "bash", timeout_s=10),
 DominoStep("ram_status", "bash:[math]::Round((free -m).FreePhysicalMemory/1MB,1)", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("nvidia_smi", "bash:nvidia-smi 2>/dev/null || 'nvidia-smi not available'", "bash", timeout_s=10),
 DominoStep("gpu_processes", "bash:nvidia-smi --query-compute-apps=pid,process_name,used_gpu_memory --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("line_count", "bash:wc -l /home/turbo/jarvis-m1-ops/src/*.py 2>/dev/null || echo 'N/A'", "bash", timeout_s=10),
 DominoStep("file_count", "bash:find /home/turbo/jarvis-m1-ops/src -name '*.py' 2>/dev/null | wc -l || echo 'N/A'", "bash", timeout_s=10),
 DominoStep("git_stats", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline | wc -l && echo 'commits' 2>/dev/null", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("git_log_today", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --since=midnight 2>/dev/null || echo 'No commits today'", "bash", timeout_s=10),
 ...
 DominoStep("git_pull", "bash:cd /home/turbo/jarvis-m1-ops && git pull --ff-only 2>&1 || echo 'Pull failed or up to date'", "bash", timeout_s=15, on_fail="skip"),
 DominoStep("gpu_temp", "bash:nvidia-smi --query-gpu=temperature.gpu --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("git_save", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git commit -m 'auto: shutdown $(date +%Y%m%d-%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15, on_fail="skip"),
 DominoStep("git_push", "bash:cd /home/turbo/jarvis-m1-ops && git push 2>&1 || echo 'Push failed'", "bash", timeout_s=30, on_fail="skip"),
 DominoStep("backup_db", "python:backup_etoile_db()", "python", on_fail="skip"),
 ...
 DominoStep("git_gc", "bash:cd /home/turbo/jarvis-m1-ops && git gc --auto 2>&1", "bash", timeout_s=30, on_fail="skip"),
 DominoStep("clear_temp", "bash:rm -f $TEMP/* -r 2>/dev/null; 'Temp cleared'", "bash", timeout_s=15, on_fail="skip"),
 ...
 steps=[
 DominoStep("git_save", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git commit -m 'EMERGENCY SAVE $(date +%Y%m%d-%H%M%S)' 2>&1 || echo 'Nothing'", "bash", timeout_s=10),
 DominoStep("git_push", "bash:cd /home/turbo/jarvis-m1-ops && git push 2>&1 || echo 'Push failed'", "bash", timeout_s=30, on_fail="skip"),
 ...
 steps=[
 DominoStep("vram_usage", "bash:nvidia-smi --query-gpu=name,memory.used,memory.total,utilization.gpu --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10),
 ...
 DominoStep("gpu", "bash:nvidia-smi --query-gpu=temperature.gpu,utilization.gpu,memory.used --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("audio_devices", "bash:Get-AudioDevice -List 2>/dev/null || Get-CimInstance Win32_SoundDevice", "bash", timeout_s=10),
 DominoStep("volume", "bash:[Audio]::Volume 2>/dev/null || 'Volume API N/A'", "bash", timeout_s=5, on_fail="skip"),
 ...
 steps=[
 DominoStep("ports", "bash:ss -tuln| wc", "bash", timeout_s=10),
 DominoStep("firewall", "bash:sudo ufw status", "bash", timeout_s=10),
 DominoStep("defender", "bash:Get-MpComputerStatus", "bash", timeout_s=10, on_fail="skip"),
 DominoStep("env_secrets", "bash:grep -rl 'sk-/|password/|secret' /home/turbo/jarvis-m1-ops/src/*.py 2>/dev/null | wc -l || echo '0 files with potential secrets'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("displays", "bash:nvidia-smi -L", "bash", timeout_s=10),
 DominoStep("monitors", "bash:Get-CimInstance WmiMonitorBasicDisplayParams -Namespace root/wmi 2>/dev/null", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("count_desktop", "bash:(ls $HOME/Desktop -File).Count", "bash", timeout_s=5),
 DominoStep("count_downloads", "bash:(ls $HOME/Downloads -File).Count", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("stash_list", "bash:cd /home/turbo/jarvis-m1-ops && git stash list 2>&1 || echo 'No stashes'", "bash", timeout_s=5),
 DominoStep("stash_pop", "bash:cd /home/turbo/jarvis-m1-ops && git stash pop 2>&1 || echo 'Nothing to pop'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("show_last", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline -3", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("gpu", "bash:nvidia-smi --query-gpu=name,temperature.gpu,utilization.gpu,memory.used,memory.total --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10, on_fail="skip"),
 DominoStep("cpu_ram", "bash:\"CPU: $((top -bn1).LoadPercentage)% | RAM Free: $([math]::Round((free -m).FreePhysicalMemory/1MB,1)) GB\"", "bash", timeout_s=10),
 DominoStep("disk", "python:get_disk_usage()", "python"),
 DominoStep("uptime", "python:get_uptime()", "python"),
 ...
 steps=[
 DominoStep("commit_count", "bash:cd /home/turbo/jarvis-m1-ops && git rev-list --count HEAD 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
 DominoStep("branch_count", "bash:cd /home/turbo/jarvis-m1-ops && git branch | wc -l 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
 DominoStep("last_commit", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline -1 2>/dev/null", "bash", timeout_s=5),
 DominoStep("file_count", "bash:cd /home/turbo/jarvis-m1-ops && git ls-files | wc -l 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("close_heavy", "bash:ps aux", "bash", timeout_s=10, on_fail="skip"),
 DominoStep("gpu_check", "bash:nvidia-smi --query-gpu=temperature.gpu,utilization.gpu --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("disable_notif", "bash:echo -Path '/tmp//SOFTWARE/Microsoft/Windows/CurrentVersion/PushNotifications' -Name 'ToastEnabled' -Value 0 2>/dev/null; 'Notif off'", "bash", timeout_s=5, on_fail="skip"),
 ...
 steps=[
 DominoStep("disable_notif", "bash:echo -Path '/tmp//SOFTWARE/Microsoft/Windows/CurrentVersion/PushNotifications' -Name 'ToastEnabled' -Value 0 2>/dev/null; 'Notif off'", "bash", timeout_s=5, on_fail="skip"),
 DominoStep("display_info", "bash:nvidia-smi -L", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("gpu_check", "bash:nvidia-smi --query-gpu=temperature.gpu,utilization.gpu,memory.used --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("git_clean", "bash:cd /home/turbo/jarvis-m1-ops && git checkout -- . 2>&1 || echo 'Nothing to clean'", "bash", timeout_s=10, on_fail="skip"),
 DominoStep("clear_cache", "python:clear_all_caches()", "python"),
 DominoStep("uv_sync", "bash:cd /home/turbo/jarvis-m1-ops && uv sync 2>&1 | tail -3", "bash", timeout_s=30, on_fail="skip"),
 ...
 steps=[
 DominoStep("backup_etoile", "python:backup_etoile_db()", "python"),
 DominoStep("git_save", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git commit -m 'auto: incremental backup $(date +%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=15, on_fail="skip"),
 ...
 steps=[
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'SYNTAX OK'", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'OK'", "bash", timeout_s=10),
 DominoStep("git_add", "bash:cd /home/turbo/jarvis-m1-ops && git add -A", "bash", timeout_s=5),
 DominoStep("git_commit", "bash:cd /home/turbo/jarvis-m1-ops && git commit -m 'auto: deploy $(date +%Y%m%d-%H%M)' 2>&1 || echo 'Nothing to commit'", "bash", timeout_s=10),
 DominoStep("git_push", "bash:cd /home/turbo/jarvis-m1-ops && git push 2>&1 || echo 'Push failed'", "bash", timeout_s=30, on_fail="skip"),
 ...
 steps=[
 DominoStep("pull", "bash:cd /home/turbo/jarvis-m1-ops && git pull --ff-only 2>&1 || echo 'Up to date'", "bash", timeout_s=15),
 DominoStep("status", "bash:cd /home/turbo/jarvis-m1-ops && git status --short", "bash", timeout_s=5),
 DominoStep("log_today", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --since=midnight 2>/dev/null || echo 'No commits today'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("os", "bash:(free -m).Caption + ' ' + (free -m).Version", "bash", timeout_s=10),
 DominoStep("cpu", "bash:(top -bn1).Name", "bash", timeout_s=10),
 DominoStep("ram", "bash:[math]::Round((Get-CimInstance Win32_ComputerSystem).TotalPhysicalMemory/1GB,1)", "bash", timeout_s=10),
 DominoStep("gpu", "bash:(nvidia-smi -L).Name", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("git_add", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git commit -m 'quick save $(date +%H%M)' 2>&1 || echo 'Nothing'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("gpu_temp", "bash:nvidia-smi --query-gpu=name,temperature.gpu --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10),
 DominoStep("cpu_temp", "bash:Get-CimInstance MSAcpi_ThermalZoneTemperature -Namespace root/wmi 2>/dev/null | ForEach-Object { [math]::Round(($_.CurrentTemperature - 2732) / 10, 1) }", "bash", timeout_s=10, on_fail="skip"),
 ...
 DominoStep("git_save", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git commit -m 'auto: end session $(date +%Y%m%d-%H%M)' 2>&1 || echo 'Nothing'", "bash", timeout_s=15, on_fail="skip"),
 ...
 steps=[
 DominoStep("recent_commits", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline -20 2>/dev/null", "bash", timeout_s=10),
 DominoStep("tags", "bash:cd /home/turbo/jarvis-m1-ops && git tag --sort=-v:refname | head -5 2>/dev/null || echo 'No tags'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("count_all", "bash:wc -l /home/turbo/jarvis-m1-ops/data/*.log 2>/dev/null || echo '0 log files'", "bash", timeout_s=10),
 DominoStep("errors", "bash:grep -ci 'error/|exception/|fail/|critical' /home/turbo/jarvis-m1-ops/data/*.log 2>/dev/null || echo '0 errors'", "bash", timeout_s=10, on_fail="skip"),
 DominoStep("warnings", "bash:grep -ci 'warn/|warning' /home/turbo/jarvis-m1-ops/data/*.log 2>/dev/null || echo '0 warnings'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("list_all", "bash:cd /home/turbo/jarvis-m1-ops && git branch -a 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
 DominoStep("merged", "bash:cd /home/turbo/jarvis-m1-ops && git branch --merged main 2>/dev/null | grep -v main | head -10 || echo 'No merged branches'", "bash", timeout_s=5),
 DominoStep("prune", "bash:cd /home/turbo/jarvis-m1-ops && git remote prune origin 2>&1 || echo 'Done'", "bash", timeout_s=15, on_fail="skip"),
 ...
 steps=[
 DominoStep("top_cpu", "bash:ps aux | sort", "bash", timeout_s=10),
 DominoStep("count", "bash:(ps aux).Count", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("syntax_check", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK'", "bash", timeout_s=10),
 DominoStep("git_diff", "bash:cd /home/turbo/jarvis-m1-ops && git diff --stat 2>/dev/null || echo 'No changes'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("lines", "bash:wc -l /home/turbo/jarvis-m1-ops/src/*.py 2>/dev/null", "bash", timeout_s=10),
 DominoStep("files", "bash:find /home/turbo/jarvis-m1-ops/src -name '*.py' 2>/dev/null | wc -l", "bash", timeout_s=5),
 DominoStep("git_size", "bash:du -sh /home/turbo/jarvis-m1-ops/.git 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
 DominoStep("data_size", "bash:du -sh /home/turbo/jarvis-m1-ops/data 2>/dev/null || echo 'N/A'", "bash", timeout_s=5),
 ...
 DominoStep("gpu_temp", "bash:nvidia-smi --query-gpu=name,temperature.gpu,memory.used,memory.total --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10, on_fail="skip"),
 DominoStep("disk", "python:get_disk_usage()", "python"),
 DominoStep("uptime", "python:get_uptime()", "python"),
 ...
 steps=[
 DominoStep("ram_total", "bash:[math]::Round((Get-CimInstance Win32_ComputerSystem).TotalPhysicalMemory/1GB,1)", "bash", timeout_s=10),
 DominoStep("ram_free", "bash:[math]::Round((free -m).FreePhysicalMemory/1MB,1)", "bash", timeout_s=10),
 DominoStep("top_ram", "bash:ps aux | sort", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("gpu_info", "bash:nvidia-smi --query-gpu=name,temperature.gpu,utilization.gpu,memory.used,memory.total,power.draw --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("gpu_usage", "bash:nvidia-smi --query-gpu=utilization.gpu,memory.used,temperature.gpu --format=csv,noheader 2>/dev/null || 'N/A'", "bash", timeout_s=10, on_fail="skip"),
 ...
 steps=[
 DominoStep("critical_vars", "bash:$vars = @('PATH','TURBO_DIR','OLLAMA_NUM_PARALLEL','CUDA_VISIBLE_DEVICES'); foreach($v in $vars){\"$v = $(if($env:$v){'SET'}else{'NOT SET'})\"}", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("git_save", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git commit -m 'auto: weekend prep $(date +%Y%m%d)' 2>&1 || echo 'Nothing'", "bash", timeout_s=15, on_fail="skip"),
 DominoStep("git_push", "bash:cd /home/turbo/jarvis-m1-ops && git push 2>&1 || echo 'Push failed'", "bash", timeout_s=30, on_fail="skip"),
 ...
 steps=[
 DominoStep("git_pull", "bash:cd /home/turbo/jarvis-m1-ops && git pull --ff-only 2>&1 || echo 'Up to date'", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("cpu", "bash:powershell -Command \"(top -bn1).Name\" 2>/dev/null || echo 'CPU info N/A'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("recent", "bash:cd /home/turbo/jarvis-m1-ops && tail -10 data/claude_tool_log.jsonl 2>/dev/null | head -5 || echo 'No logs'", "bash", timeout_s=5),
 DominoStep("errors", "bash:cd /home/turbo/jarvis-m1-ops && grep -ic 'error/|exception' data/claude_tool_log.jsonl 2>/dev/null || echo '0 errors'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("contributors", "bash:cd /home/turbo/jarvis-m1-ops && git shortlog -sn --all 2>/dev/null | head -5 || echo 'Git error'", "bash", timeout_s=5),
 DominoStep("branches", "bash:cd /home/turbo/jarvis-m1-ops && git branch -a 2>/dev/null | wc -l || echo '?'", "bash", timeout_s=5),
 DominoStep("tags", "bash:cd /home/turbo/jarvis-m1-ops && git tag -l 2>/dev/null | wc -l || echo '0 tags'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("changelog", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --since='30 days ago' | head -20", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("errors", "bash:cd /home/turbo/jarvis-m1-ops && grep -ic 'error/|exception/|traceback' data/claude_tool_log.jsonl 2>/dev/null || echo '0'", "bash", timeout_s=5),
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'SYNTAX OK'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("check", "bash:cd /home/turbo/jarvis-m1-ops && wc -l README.md 2>/dev/null || echo 'No README.md'", "bash", timeout_s=3),
 ...
 steps=[
 DominoStep("pytest", "bash:cd /home/turbo/jarvis-m1-ops && python -m pytest tests/ -q --tb=short 2>/dev/null | tail -10 || echo 'No pytest tests'", "bash", timeout_s=60),
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'All syntax OK'", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("cov", "bash:cd /home/turbo/jarvis-m1-ops && python -m pytest --cov=src/ --cov-report=term-missing tests/ 2>/dev/null | tail -15 || echo 'Coverage N/A'", "bash", timeout_s=60),
 ...
 steps=[
 DominoStep("sqlite", "bash:cd /home/turbo/jarvis-m1-ops && python -c \"import sqlite3;c=sqlite3.connect('data/etoile.db');print(f'etoile.db: {c.execute(/\"SELECT COUNT(*) FROM sqlite_master WHERE type=///\"table///\"/\").fetchone()[0]} tables')\" 2>/dev/null || echo 'etoile.db N/A'", "bash", timeout_s=5),
 DominoStep("jarvis", "bash:cd /home/turbo/jarvis-m1-ops && python -c \"import sqlite3;c=sqlite3.connect('data/jarvis.db');print(f'jarvis.db: {c.execute(/\"SELECT COUNT(*) FROM sqlite_master WHERE type=///\"table///\"/\").fetchone()[0]} tables')\" 2>/dev/null || echo 'jarvis.db N/A'", "bash", timeout_s=5),
 ...
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK' || echo 'SYNTAX ERROR!'", "bash", timeout_s=10),
 DominoStep("cluster", "bash:curl -s --max-time 3 http://127.0.0.1:1234/api/v1/models 2>/dev/null && echo 'M1 OK' || echo 'M1 DOWN'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("recent", "bash:cd /home/turbo/jarvis-m1-ops && ls -la data/*.log 2>/dev/null | tail -5 || echo 'No log files'", "bash", timeout_s=5),
 DominoStep("errors", "bash:cd /home/turbo/jarvis-m1-ops && grep -i 'error/|exception/|fail' data/*.log 2>/dev/null | tail -10 || echo 'No errors in logs'", "bash", timeout_s=10),
 DominoStep("tts", "python:edge_tts_speak('Analyse des logs terminee.')", "python"),
 ],
 category="monitoring",
 ...
 steps=[
 DominoStep("status", "bash:cd /home/turbo/jarvis-m1-ops && git status -s", "bash", timeout_s=5),
 DominoStep("test", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("git", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline -5", "bash", timeout_s=5),
 DominoStep("status", "bash:cd /home/turbo/jarvis-m1-ops && git status -s | wc -l", "bash", timeout_s=5),
 DominoStep("summary", "python:project_summary()", "python"),
 ...
 DominoStep("integrity", "bash:cd /home/turbo/jarvis-m1-ops && python -c \"import sqlite3;[print(f'{db}: {sqlite3.connect(f/\"data/{db}/\").execute(/\"PRAGMA integrity_check/\").fetchone()[0]}') for db in ['etoile.db','jarvis.db','sniper.db']]\" 2>/dev/null || echo 'Integrity check error'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'SYNTAX ALL OK'", "bash", timeout_s=15),
 DominoStep("summary", "python:project_summary()", "python"),
 DominoStep("cluster", "python:cluster_node_count()", "python"),
 DominoStep("ram", "python:system_memory_usage()", "python"),
 DominoStep("disk", "python:get_disk_usage()", "python"),
 ...
 steps=[
 DominoStep("import_bench", "bash:cd /home/turbo/jarvis-m1-ops && python -c \"import time;s=time.time();from src.commands import COMMANDS;from src.voice_correction import IMPLICIT_COMMANDS;from src.domino_pipelines import DOMINO_PIPELINES;print(f'Import: {time.time()-s:.3f}s')\"", "bash", timeout_s=10),
 DominoStep("ram", "python:system_memory_usage()", "python"),
 ...
 steps=[
 DominoStep("profile", "bash:cd /home/turbo/jarvis-m1-ops && python -c \"import cProfile;import pstats;pr=cProfile.Profile();pr.enable();from src.commands import COMMANDS;pr.disable();ps=pstats.Stats(pr);ps.sort_stats('cumulative');ps.print_stats(5)\" 2>/dev/null || echo 'cProfile error'", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("disk", "python:get_disk_usage()", "python"),
 DominoStep("large_files", "bash:cd /home/turbo/jarvis-m1-ops && find . -name '*.py' -size +100k 2>/dev/null | head -5 || dir /s /b *.py 2>NUL | head -5", "bash", timeout_s=10),
 DominoStep("db_sizes", "bash:ls -lh /home/turbo/jarvis-m1-ops/data/*.db 2>/dev/null || dir /home/turbo/jarvis-m1-ops/data/*.db 2>NUL", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("week_log", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --since='7 days ago'", "bash", timeout_s=5),
 DominoStep("summary", "python:project_summary()", "python"),
 DominoStep("todos", "bash:cd /home/turbo/jarvis-m1-ops && grep -rn 'TODO/|FIXME' src/*.py 2>/dev/null | wc -l || echo '0'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("todos", "bash:cd /home/turbo/jarvis-m1-ops && grep -rn 'TODO/|FIXME/|HACK/|XXX' src/*.py 2>/dev/null | head -20 || echo 'Aucun TODO'", "bash", timeout_s=10),
 DominoStep("loc", "python:count_lines_of_code()", "python"),
 ...
 steps=[
 DominoStep("yesterday", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --since='1 day ago'", "bash", timeout_s=5),
 DominoStep("status", "bash:cd /home/turbo/jarvis-m1-ops && git status --short | wc -l", "bash", timeout_s=5),
 DominoStep("summary", "python:project_summary()", "python"),
 ...
 steps=[
 DominoStep("branch", "bash:cd /home/turbo/jarvis-m1-ops && git branch --show-current", "bash", timeout_s=3),
 ...
 steps=[
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && echo 'OK'", "bash", timeout_s=10),
 DominoStep("tests", "python:test_voice_match('ouvre chrome')", "python"),
 ...
 steps=[
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'ALL OK'", "bash", timeout_s=15),
 DominoStep("tests", "python:test_voice_match('ouvre chrome')", "python"),
 DominoStep("summary", "python:project_summary()", "python"),
 DominoStep("git", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline -5", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("imports", "bash:cd /home/turbo/jarvis-m1-ops && python -c 'from src.commands import COMMANDS; from src.voice_correction import IMPLICIT_COMMANDS; from src.domino_pipelines import DOMINO_PIPELINES; from src.domino_executor import _PYTHON_REGISTRY; print(\"ALL IMPORTS OK\")'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("push", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git status --short", "bash", timeout_s=5),
 DominoStep("log_week", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --since='5 days ago' | head -15", "bash", timeout_s=5),
 DominoStep("summary", "python:project_summary()", "python"),
 ...
 steps=[
 DominoStep("status", "bash:cd /home/turbo/jarvis-m1-ops && git status --short", "bash", timeout_s=5),
 DominoStep("stash", "bash:cd /home/turbo/jarvis-m1-ops && git stash list 2>/dev/null || echo 'Aucun stash'", "bash", timeout_s=5),
 DominoStep("branches", "bash:cd /home/turbo/jarvis-m1-ops && git branch -a 2>/dev/null | head -10", "bash", timeout_s=5),
 DominoStep("tags", "bash:cd /home/turbo/jarvis-m1-ops && git tag -l | tail -5 2>/dev/null || echo 'Aucun tag'", "bash", timeout_s=5),
 DominoStep("log", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline -5", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("reflog", "bash:cd /home/turbo/jarvis-m1-ops && git reflog --oneline -10", "bash", timeout_s=5),
 DominoStep("stash", "bash:cd /home/turbo/jarvis-m1-ops && git stash list 2>/dev/null || echo 'Aucun stash'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("lint", "bash:cd /home/turbo/jarvis-m1-ops && ruff check src/ 2>/dev/null | tail -5 || echo 'ruff non installe'", "bash", timeout_s=15),
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK'", "bash", timeout_s=10),
 DominoStep("loc", "python:count_lines_of_code()", "python"),
 ...
 steps=[
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'SYNTAX OK'", "bash", timeout_s=15),
 DominoStep("git_add", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git status --short", "bash", timeout_s=5),
 DominoStep("commit", "bash:cd /home/turbo/jarvis-m1-ops && git diff --cached --stat", "bash", timeout_s=5),
 DominoStep("push", "bash:cd /home/turbo/jarvis-m1-ops && git push origin main 2>&1 | tail -3", "bash", timeout_s=30),
 ...
 steps=[
 DominoStep("pull", "bash:cd /home/turbo/jarvis-m1-ops && git pull --rebase 2>&1 | tail -3", "bash", timeout_s=15),
 ...
 steps=[
 DominoStep("log_week", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --since='1 week ago'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("git_clean_check", "bash:cd /home/turbo/jarvis-m1-ops && git status --short | wc -l", "bash", timeout_s=5),
 ...
 DominoStep("git_secrets", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --diff-filter=A -- '*.env' '*.key' '*.pem' 2>/dev/null | head -3 || echo 'Aucun secret commite'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'SYNTAX OK'", "bash", timeout_s=15),
 DominoStep("imports", "bash:cd /home/turbo/jarvis-m1-ops && python -c 'from src.commands import COMMANDS; from src.voice_correction import IMPLICIT_COMMANDS; from src.domino_pipelines import DOMINO_PIPELINES; from src.domino_executor import _PYTHON_REGISTRY; print(\"IMPORTS OK\")'", "bash", timeout_s=10),
 DominoStep("summary", "python:project_summary()", "python"),
 ...
 steps=[
 DominoStep("save", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git stash 2>/dev/null; echo 'Work saved'", "bash", timeout_s=10),
 DominoStep("stats", "python:project_summary()", "python"),
 ...
 DominoStep("sizes", "bash:cd /home/turbo/jarvis-m1-ops && ls -lh data/*.db 2>/dev/null || dir data/*.db", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("syntax_all", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && python -m py_compile src/domino_executor.py && echo 'ALL SYNTAX OK'", "bash", timeout_s=15),
 DominoStep("imports", "bash:cd /home/turbo/jarvis-m1-ops && python -c 'from src.commands import COMMANDS; from src.voice_correction import IMPLICIT_COMMANDS; from src.domino_pipelines import DOMINO_PIPELINES; print(\"ALL IMPORTS OK\")'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("validate", "bash:cd /home/turbo/jarvis-m1-ops && python -c \"import json,glob; errs=0; [print(f'{f}: OK') if json.load(open(f)) else None for f in glob.glob('data/*.json')[:10]]\" 2>&1 | head -15 || echo 'Erreur validation'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("schema", "bash:cd /home/turbo/jarvis-m1-ops && python -c \"import sqlite3; c=sqlite3.connect('data/etoile.db'); [print(r[0]) for r in c.execute('SELECT name FROM sqlite_master WHERE type=/\"table/\" ORDER BY name')]\"", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("count", "bash:cd /home/turbo/jarvis-m1-ops && wc -l src/*.py 2>/dev/null || echo 'wc non disponible'", "bash", timeout_s=5),
 DominoStep("files", "bash:cd /home/turbo/jarvis-m1-ops && find src -name '*.py' -type f 2>/dev/null | wc -l || echo '?'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("ci_status", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline -3", "bash", timeout_s=5),
 DominoStep("syntax_check", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && echo 'Syntax OK'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && python -m py_compile src/voice_correction.py && python -m py_compile src/domino_pipelines.py && echo 'ALL OK'", "bash", timeout_s=15),
 DominoStep("git_add", "bash:cd /home/turbo/jarvis-m1-ops && git add -A && git status --short", "bash", timeout_s=5),
 DominoStep("git_push", "bash:cd /home/turbo/jarvis-m1-ops && git push origin main 2>&1 | tail -3", "bash", timeout_s=30),
 ...
 DominoStep("diff", "bash:cd /home/turbo/jarvis-m1-ops && git diff HEAD~1 --stat", "bash", timeout_s=10),
 ],
 category="ci_cd",
 ...
 steps=[
 DominoStep("git_today", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline --since='1 day ago'", "bash", timeout_s=5),
 DominoStep("stats", "python:count_commands()", "python"),
 DominoStep("corrections", "python:count_voice_corrections()", "python"),
 ...
 steps=[
 DominoStep("branch", "bash:cd /home/turbo/jarvis-m1-ops && git branch --show-current", "bash", timeout_s=3),
 DominoStep("diff_stats", "bash:cd /home/turbo/jarvis-m1-ops && git diff --stat", "bash", timeout_s=5),
 DominoStep("log_recent", "bash:cd /home/turbo/jarvis-m1-ops && git log --oneline -10", "bash", timeout_s=5),
 DominoStep("syntax", "bash:cd /home/turbo/jarvis-m1-ops && python -m py_compile src/commands.py && echo 'Syntax OK'", "bash", timeout_s=10),
 ...
 steps=[
 DominoStep("env_check", r"bash:cd /home/turbo/jarvis-m1-ops && grep -r 'DRY_RUN\|ENABLE_\|DISABLE_\|FEATURE_' .env 2>/dev/null || echo 'Pas de .env ou pas de flags'", "bash", timeout_s=5),
 DominoStep("config_check", r"bash:cd /home/turbo/jarvis-m1-ops && grep -rn 'DRY_RUN\|ENABLE_\|FEATURE_' src/config*.py 2>/dev/null | head -10 || echo 'Pas de flags dans config'", "bash", timeout_s=5),
 ...
 steps=[
 DominoStep("fetch", "bash:cd /home/turbo/jarvis-m1-ops && git fetch --all 2>&1 | tail -3", "bash", timeout_s=15),
 DominoStep("status", "bash:cd /home/turbo/jarvis-m1-ops && git status --short", "bash", timeout_s=5),
 DominoStep("behind", "bash:cd /home/turbo/jarvis-m1-ops && git log HEAD..origin/main --oneline 2>/dev/null || echo 'A jour'", "bash", timeout_s=5),
 ...
 DominoStep("gpu_temp", "bash:nvidia-smi --query-gpu=name,temperature.gpu,memory.used,memory.total --format=csv,noheader", "bash"),
 ...
 "mode turbo"],
 steps=[
 DominoStep("close_apps", "bash:ps aux chrome,msedge,discord 2>/dev/null | Stop-Process ", "bash"),
 DominoStep("gpu_boost", "bash:nvidia-smi -pm 1", "bash"),
 ...
 steps=[
 DominoStep("gpu", "bash:nvidia-smi --query-gpu=name,temperature.gpu,memory.used,memory.total,utilization.gpu --format=csv,noheader", "bash"),
 DominoStep("cpu_ram", "bash:top -bn1| ForEach-Object { '{0:N0} MB free / {1:N0} MB total' -f ($_.FreePhysicalMemory/1024), ($_.TotalVisibleMemorySize/1024) })", "bash"),
 DominoStep("disk", "bash:df -h 2>/dev/null | ForEach-Object { '{0}: {1:N1} GB free / {2:N1} GB total' -f $_.Name, ($_.Free/1GB), (($_.Used+$_.Free)/1GB) }", "bash"),
