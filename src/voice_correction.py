...
PHONETIC_GROUPS: list[list[str]] = [
    ...
    # Vague 30 — Microservices / Monitoring / CSS phonetiques
    ["cqrs", "ce cul air esse", "sequeuairesse", "cqrse"],
    ["prometheus", "pro me the us", "prome te eusse", "prometeus"],
    ["grafana", "gra fa na", "graffana", "grafanna"],
    ["pagerduty", "pager du ti", "pageurdiuti", "pageurduty"],
    ["tailwind", "taille wind", "talewind", "tailewinde"],
    ["gsap", "ji sap", "jisappe", "gsappe"],
    ["framer", "freme eur", "freimeur", "frameeur"],
    ["emotion", "emo sion", "emossion", "imotion"],
    ["postcss", "post css", "postcesse", "postcess"],
    # Vague 31 — Security / Auth phonetiques
    ["passkey", "passe ki", "pas ski", "passki"],
    ["totp", "ti o ti pi", "totepe", "totpi"],
    ["saml", "sa mel", "samel", "samele"],
    ["sso", "esse esse o", "esseso", "esso"],
    ["rbac", "air bac", "erbaque", "arbac"],
    ["oidc", "o i de ce", "oidecer", "oidici"],
    ["pkce", "pi ka ce e", "pikase", "pikcee"],
    ["vault", "vaulte", "volte", "volete"],
    # Vague 32 — Blockchain / Web3 phonetiques
    ["solana", "so la na", "solanna", "solenna"],
    ["ethereum", "e ter yom", "eteriom", "iterium"],
    ["metamask", "meta mask", "meta masque", "metamaske"],
    ["defi", "de fi", "defaille", "difai"],
    ["nft", "enne effe te", "enefti", "enefte"],
    ["ipfs", "i pe effe esse", "ipefesse", "aipfs"],
    ["layer2", "laye air deux", "lailleur deux", "l2"],
    ["merkle", "merkel", "merkele", "mairkel"],
    # Vague 33 — AI / GenAI phonetiques
    ["llama", "la ma", "lama", "yama"],
    ["mistral", "mis tral", "mistralle", "mistrale"],
    ["gemma", "jem ma", "jemma", "guemma"],
    ["claude", "clod", "clode", "claude"],
    ["openai", "open aille", "openaie", "opennai"],
    ["chatgpt", "chat ji pi ti", "chatjipipi", "tchatgpt"],
    ["copilot", "co pi lot", "copilotte", "copilaute"],
    ["langchain", "lang tchaine", "langtchenne", "langchaine"],
    # Vague 34 — Observabilite phonetiques
    ["opentelemetry", "open telemetri", "opentele", "otel"],
    ["sentry", "sen tri", "sentri", "centri"],
    ["newrelic", "niou relic", "nioureleque", "newrelique"],
    ["loki", "lo ki", "loqui", "lokki"],
    ["tempo", "tem po", "tempau", "tampo"],
    ["mimir", "mi mir", "mimir", "mimire"],
    ["thanos", "ta nos", "tanos", "tanausse"],
    # Vague 35 — Edge / CDN phonetiques
    ["cloudflare", "cloud flaire", "claoude fleur", "cloudflair"],
    ["akamai", "a ka maie", "akamaie", "akamai"],
    ["fastly", "fast li", "faste li", "fasteli"],
    ["vercel", "ver cel", "vercelle", "verselle"],
    ["deno", "de no", "dino", "dineau"],
    ["bun", "beune", "bonne", "bane"],
    ["turbo", "tur bo", "turbeau", "teurbo"],
    # Vague 36 — WASM / Low-level phonetiques
    ["webassembly", "web assemble i", "webassembli", "ouebassembli"],
    ["wasm", "ouazme", "ouasm", "ouasseme"],
    ["emscripten", "em scripten", "emscripte", "emescripten"],
    ["llvm", "el el ve em", "elveem", "elelvm"],
    ["simd", "si em de", "simde", "simedi"],
    ["zig", "zigue", "zig", "zeeg"],
    ["nim", "nime", "neeme", "nimme"],
    # Vague 37 — Quantum / HPC phonetiques
    ["qiskit", "quis kit", "kisskite", "quiskite"],
    ["cirq", "sirk", "cirque", "ceerc"],
    ["cuda", "cou da", "cuda", "kiouda"],
    ["rocm", "rock em", "rokme", "rocem"],
    ["tensor", "ten seur", "tenceur", "tanseur"],
    ["triton", "tri ton", "tritonne", "traytonn"],
    # Vague 38 — Protocol / Serialization phonetiques
    ["protobuf", "proto buff", "protobeufe", "protobuf"],
    ["avro", "av ro", "avreau", "avrosse"],
    ["thrift", "trifte", "trift", "srifte"],
    ["msgpack", "message pack", "emessgpak", "msgpak"],
    ["capnproto", "cap enne proto", "capnpro", "kapnproto"],
    ["flatbuffers", "flat buffer", "flatbofeur", "flatbeufeur"],
    # Vague 39 — Termes francais tech courants phonetiques
    ["debogage", "debug age", "debogaje", "deboguage"],
    ["hebergement", "eber je ment", "ebergement", "ebergeumant"],
    ["telechargement", "tele charge ment", "telechargeman", "telechargement"],
    ["mise a jour", "mi sa jour", "misajour", "miz a jour"],
    ["sauvegarde", "sov garde", "sovgard", "soveguarde"],
    ["restauration", "restau ration", "restaurasion", "restaracion"],
    ["redemarrage", "re dem arage", "redemarage", "redemaraje"],
    # Vague 40 — Noms de modeles IA courants phonetiques
    ["deepseek", "dip sik", "deepseeke", "dipsik"],
    ["qwen", "kouen", "couenne", "queune"],
    ["phi", "fi", "fie", "faille"],
    ["llama", "ya ma", "lam a", "llam"],
    ["mixtral", "mix tral", "mikstral", "mixtralle"],
...
IMPLICIT_COMMANDS: dict[str, str] = {
    ...
    # Vague 98 — Microservices raccourcis
    "microservice": "check microservices",
    "cqrs": "check cqrs",
    "saga": "check saga pattern",
    "circuit breaker": "check circuit breaker",
    "discovery": "service discovery",
    # Vague 99 — Monitoring raccourcis
    "prometheus": "check prometheus",
    "grafana": "ouvre grafana",
    "alertmanager": "check alertmanager",
    "sla": "check sla",
    "uptime": "check uptime",
    "pagerduty": "check pagerduty",
    # Vague 100 — CSS/Animation raccourcis
    "tailwind": "check tailwind",
    "sass": "compile sass",
    "scss": "compile scss",
    "animation": "css animation",
    "gsap": "check gsap",
    "framer": "check framer motion",
}
