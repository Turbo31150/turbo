...
JarvisCommand("sim_db_backup_all", "pipeline", "Backup toutes les DBs: jarvis + etoile + trading", [
    ...
    ], "pipeline", "powershell:$r = Invoke-RestMethod -Uri 'http://10.5.0.2:1234/api/v1/models' -Headers @{'Authorization'='Bearer LMSTUDIO_KEY_M1_REDACTED'} -TimeoutSec 5; $loaded = ($r.models | Where-Object {$_.loaded_instances -gt 0}).id -join ', '; \"M1: $loaded\";;powershell:$r = Invoke-RestMethod -Uri 'http://192.168.1.26:1234/api/v1/models' -Headers @{'Authorization'='Bearer LMSTUDIO_KEY_M2_REDACTED'} -TimeoutSec 5; $loaded = ($r.models | Where-Object {$_.loaded_instances -gt 0}).id -join ', '; \"M2: $loaded\";;powershell:$r = Invoke-RestMethod -Uri 'http://192.168.1.113:1234/api/v1/models' -Headers @{'Authorization'='Bearer LMSTUDIO_KEY_M3_REDACTED'} -TimeoutSec 5; $loaded = ($r.models | Where-Object {$_.loaded_instances -gt 0}).id -join ', '; \"M3: $loaded\";;powershell:$r = Invoke-RestMethod -Uri 'http://127.0.0.1:11434/api/tags' -TimeoutSec 5; \"OL1: \" + ($r.models.name -join ', ')"),
    ...
    ], "pipeline", "powershell:Invoke-RestMethod -Uri 'http://10.5.0.2:1234/api/v1/models/load' -Method Post -Body '{\"model\":\"qwen3-8b\"}' -ContentType 'application/json' -Headers @{'Authorization'='Bearer LMSTUDIO_KEY_M1_REDACTED'} -TimeoutSec 60; 'M1 qwen3-8b rechargement lance';;sleep:5;;powershell:$r = Invoke-RestMethod -Uri 'http://10.5.0.2:1234/api/v1/models' -Headers @{'Authorization'='Bearer LMSTUDIO_KEY_M1_REDACTED'} -TimeoutSec 5; $loaded = ($r.models | Where-Object {$_.loaded_instances -gt 0}).id -join ', '; \"M1 modeles actifs: $loaded\"", confirm=True),
