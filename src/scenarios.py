...
SCENARIO_TEMPLATES: list[dict] = [
    ...
    {"name": "matin_rapport_cluster", "category": "routine", "difficulty": "normal",
     ...
     "voice_input": "comment va le cluster", "expected": ["statut_cluster", "jarvis_status"],
    ...
    {"name": "nav_site_specifique", "category": "navigation", "difficulty": "normal",
     ...
     "voice_input": "va sur github", "expected": ["ouvrir_github", "aller_sur_site"],
    ...
    {"name": "win_show_desktop", "category": "fenetre", "difficulty": "easy",
     ...
     "voice_input": "montre le bureau", "expected": ["minimiser_tout", "ouvrir_bureau"],
    ...
    {"name": "dev_docker_ps", "category": "dev", "difficulty": "normal",
     ...
     "voice_input": "docker ps", "expected": ["docker_ps", "container_list"],
    ...
    {"name": "skill_mode_dev", "category": "pipeline", "difficulty": "normal",
     ...
     "voice_input": "mode dev", "expected": ["mode_dev", "mode_developpeur", "mode_travail"],
    ...
    {"name": "sys_uptime", "category": "systeme", "difficulty": "easy",
     ...
     "voice_input": "uptime", "expected": ["uptime", "uptime_pc"],
    ...
    {"name": "sys_ping", "category": "systeme", "difficulty": "normal",
     ...
     "voice_input": "ping google", "expected": ["ping_host", "ping_google"],
    ...
    {"name": "sys_ports_ouverts", "category": "systeme", "difficulty": "normal",
     ...
     "voice_input": "quels ports sont ouverts", "expected": ["ports_ouverts", "netstat", "port_scan_local"],
    ...
    {"name": "sys_focus_on", "category": "systeme", "difficulty": "normal",
     ...
     "voice_input": "ne pas deranger", "expected": ["focus_assist_on", "mode_focus"],
    ...
    {"name": "sys_planifier_arret", "category": "systeme", "difficulty": "hard",
     ...
     "voice_input": "eteins dans 30 minutes", "expected": ["planifier_arret", "shutdown_timer_30"],
     "expected_result": "Arret programme"},
    ...
    {"name": "sys_date", "category": "systeme", "difficulty": "easy",
     ...
     "voice_input": "quelle date", "expected": ["date_actuelle", "quelle_date"],
     "expected_result": "Date affichee"},
    {"name": "sys_heure", "category": "systeme", "difficulty": "easy",
     "description": "Voir l'heure actuelle",
     "voice_input": "quelle heure", "expected": ["heure_actuelle", "quelle_heure"],
    ...
    {"name": "file_gros_fichiers", "category": "fichiers", "difficulty": "normal",
     ...
     "voice_input": "gros fichiers", "expected": ["gros_fichiers", "large_files"],
    ...
    {"name": "nav_gmail", "category": "navigation", "difficulty": "easy",
     ...
     "voice_input": "ouvre gmail", "expected": ["ouvrir_gmail", "aller_sur_site"],
    ...
    {"name": "dev_git_push", "category": "dev", "difficulty": "normal",
     ...
     "voice_input": "git push", "expected": ["git_push", "auto_push"],
    ...
    {"name": "media_volume_precis", "category": "media", "difficulty": "normal",
     ...
     "voice_input": "volume a 50", "expected": ["volume_precis", "volume_50"],
    ...
    {"name": "correction_dockeur", "category": "correction", "difficulty": "hard",
     ...
     "voice_input": "liste les conteneurs dockeur", "expected": ["docker_ps", "container_list"],
    ...
    {"name": "skill_mode_stream", "category": "pipeline", "difficulty": "normal",
     ...
     "voice_input": "mode stream", "expected": ["mode_stream", "mode_streaming"],
    ...
    {"name": "skill_backup_rapide", "category": "pipeline", "difficulty": "normal",
     ...
     "voice_input": "backup rapide", "expected": ["backup_rapide", "backup_etoile"],
    ...
    {"name": "skill_routine_soir_bis", "category": "pipeline", "difficulty": "normal",
     ...
     "voice_input": "je vais dormir", "expected": ["routine_soir", "bonne_nuit"],
     "expected_result": "Pipeline routine_soir execute"},
    ...
    {"name": "trading_sniper", "category": "trading", "difficulty": "hard",
     ...
     "voice_input": "sniper breakout", "expected": ["sniper_breakout", "launch_sniper_breakout"],
    ...
    {"name": "sys_screen_record", "category": "systeme", "difficulty": "normal",
     ...
     "voice_input": "enregistre l'ecran", "expected": ["screen_recording", "enregistrer_ecran", "enregistre_ecran"],
    ...
    {"name": "sys_startup_apps", "category": "systeme", "difficulty": "normal",
     ...
     "voice_input": "apps au demarrage", "expected": ["demarrage_apps", "startup_apps_list"],
