...
| M3 | http://192.168.1.113:1234 | Bearer LMSTUDIO_KEY_M3_REDACTED | mistral-7b |
| M1 | http://10.5.0.2:1234 | Bearer LMSTUDIO_KEY_M1_REDACTED | qwen3-8b (RAPIDE 0.6-2.5s) + qwen3-30b (profond) |
