...
### Verification:
```bash
curl -s http://127.0.0.1:18800/tool -d '{"name":"list_dir","args":{"path":"/home/turbo/jarvis-m1-ops"}}'
curl -s http://127.0.0.1:18800/tool -d '{"name":"read_file","args":{"path":"/home/turbo/jarvis-m1-ops/README.md"}}'
```
