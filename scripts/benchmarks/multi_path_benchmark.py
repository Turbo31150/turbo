...
=======
TURBO_ROOT = Path("/home/turbo/jarvis")
>>>>>>> Stashed changes
...
=======
        cmd = ["node", "/home/turbo/jarvis/gemini-proxy.js", "--json", prompt]
    else:
        cmd = ["node", "/home/turbo/jarvis/claude-proxy.js", "--json", "--budget", "0.30", prompt]
>>>>>>> Stashed changes
