...
CLUSTER_NODES = [
    ...
    {"id": "M2", "weight": 1.4, "type": "lmstudio",
     "url": "http://192.168.1.26:1234/api/v1/chat", "model": "deepseek-coder-v2-lite-instruct", "timeout": 30},
    {"id": "M3", "weight": 1.0, "type": "lmstudio",
     "url": "http://192.168.1.113:1234/api/v1/chat", "model": "mistral-7b-instruct-v0.3", "timeout": 30},
