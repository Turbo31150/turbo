...
cd /d F:\BUREAU\turbo
start /b C:\Users\franc\.local\bin\uv.exe run python -c "from src.config import SCRIPTS; import subprocess, sys; subprocess.Popen([sys.executable, str(SCRIPTS['jarvis_api'])])"
