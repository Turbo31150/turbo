...
$body2 = @{
    ...
    system_prompt = "Tu es le cerveau local de JARVIS v10.6. Tu connais 450 commandes vocales, 77 skills et 73 outils MCP. Identifie la commande ou le skill qui correspond. Reponds: COMMANDE: nom ou SKILL: nom."
    temperature = 0.5
