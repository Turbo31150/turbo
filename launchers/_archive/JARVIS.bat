...
"/home/turbo/jarvis-m1-ops\.venv\Scripts\python.exe" scripts\tools\setup_hardlinks.py >nul 2>&1

:: Lancer le systray en arriere-plan
start /B "" "/home/turbo/jarvis-m1-ops\.venv\Scripts\pythonw.exe" -c "from src.systray import run_systray; run_systray()"
