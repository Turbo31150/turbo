...
class TestBuildOptions:
    ...
    def test_build_options_returns_object(self):
        from src.orchestrator import build_options
        opts = build_options(cwd="/home/turbo/jarvis-m1-ops")
    ...
    def test_build_options_commander_flag(self):
        ...
        opts_cmd = build_options(cwd="/home/turbo/jarvis-m1-ops", commander=True)
        opts_std = build_options(cwd="/home/turbo/jarvis-m1-ops", commander=False)
