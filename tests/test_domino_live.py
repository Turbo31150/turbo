...
try:
    integrity = ps("& '/\Users/franc/.local/bin/uv.exe' run python -c \"import sqlite3; c=sqlite3.connect('/home/turbo/jarvis-m1-ops/data/etoile.db'); print(c.execute('PRAGMA integrity_check').fetchone()[0])\" 2>&1")
