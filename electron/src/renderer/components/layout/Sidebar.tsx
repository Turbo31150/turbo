...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'workflows', label: 'Workflows', icon: <PipelineIcon /> },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'health', label: 'Health', icon: <ChartIcon /> },
      ...
      { id: 'infra', label: 'Infra', icon: <ServerIcon /> },
      { id: 'mesh', label: 'Mesh', icon: <ServerIcon /> },
      { id: 'automation', label: 'Automation', icon: <GearIcon /> },
      { id: 'processes', label: 'Processes', icon: <ServerIcon /> },
      { id: 'snapshots', label: 'Snapshots', icon: <ServerIcon /> },
      { id: 'system', label: 'System', icon: <GearIcon /> },
      { id: 'notifications', label: 'Notifications', icon: <LogsIcon /> },
      { id: 'alerts', label: 'Alerts', icon: <LogsIcon /> },
